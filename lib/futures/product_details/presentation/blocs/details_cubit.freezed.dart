...
class _$DetailsStateImpl implements _DetailsState {
  const _$DetailsStateImpl({this.size, this.color});
  ...
  @override
  String toString() {
    return 'DetailsState(size: $size, color: $color)';
  }
...
abstract class _DetailsState implements DetailsState {
  const factory _DetailsState({final String? size, final String? color}) =
      _$DetailsStateImpl;
