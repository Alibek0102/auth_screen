...
class _$FavoriteStateImpl implements _FavoriteState {
  const _$FavoriteStateImpl({final List<ProductEntity> products = const []})
      : _products = products;
  ...
  @override
  String toString() {
    return 'FavoriteState(products: $products)';
  }
...
abstract class _FavoriteState implements FavoriteState {
  const factory _FavoriteState({final List<ProductEntity> products}) =
      _$FavoriteStateImpl;
